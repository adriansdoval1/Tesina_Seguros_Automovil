...
---
\thispagestyle{empty}
```{r cover1, echo=FALSE, out.width='100%', fig.align='left'}
knitr::include_graphics("Formato-Portada-ESPECIALIDAD_ASC1.pdf")
```

\thispagestyle{empty}
```{r cover2, echo=FALSE, out.width='100%', fig.align='left'}
knitr::include_graphics("Formato-Portada-ESPECIALIDAD_ASC2.pdf")
```

\thispagestyle{empty}
```{r cover3, echo=FALSE, out.width='100%', fig.align='left'}
knitr::include_graphics("Formato-Portada-ESPECIALIDAD_ASC_3.pdf")
```
