...
Además, este trabajo usa el enfoque comúnmente utilizado en Ciencia de Datos para el desarrollo de modelos estadísticos enfocado en obtener la mejor predicción. El proceso inicia con la selección del problema a resolver, seguido del preprocesamiento y ajuste de los datos. Posteriormente, se elige el modelo adecuado, se valida y, finalmente, se selecciona aquel que ofrezca el mejor desempeño predictivo.
